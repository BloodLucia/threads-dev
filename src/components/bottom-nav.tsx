...
export const BottomNav: React.FC<{ className?: string }> = () => {
  return (
    <nav className="fixed bottom-0 right-0 left-0 bg-white/80 backdrop-blur-2xl w-full h-[68px] pb-[env(safe-area-inset-bottom)] grid items-center grid-cols-[repeat(5,minmax(0,1fr))]">
